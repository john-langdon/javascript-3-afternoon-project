...
/*
  ...
  let u = s + " " + t  "string 1 string 2" -- string concatenation
...
/*
  ...
  1. loop over object keys
  2. get the value at each key
  3. multiple the value by 2
  4. set the new value back on the object at the original key
   */
...
for (const property in deleteTheBigNumbers) {
  if (deleteTheBigNumbers.hasOwnProperty(property)) {
    const value = deleteTheBigNumbers[property];
    if (value > 100) {
